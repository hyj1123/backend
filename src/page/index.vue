    ...
    <div>
		<section class="data_section"> 
			<el-row :gutter="10" class="row_list">
				<el-col :span="6"><div class="pay data_list"><p class="list_number">208个</p><p>剩余车位数</p></div></el-col>
				<el-col :span="6"><div class="income data_list"><p class="list_number">127个</p><p>场内车位数</p></div></el-col>
				<el-col :span="6"><div class="hidden_investors data_list"><p class="number">686元</p><p></p>当日收费金额</div></el-col>
				<el-col :span="6"><div class="intention_investors data_list"><p class="number">264次</p><p>手动出场次数</p></div></el-col>
